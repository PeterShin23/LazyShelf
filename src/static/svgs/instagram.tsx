...
export const InstagramIcon = ({ href, strokeColor, onClick } : { href?: string; strokeColor?: string; onClick?: () => void }) => {
  const instagramHref = href ?? "https://www.instagram.com/peter.shin"
